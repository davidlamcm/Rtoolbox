...
#'@param validDays number of CALENDAR days a bdh data is valid since it is published, for price data that only valid for that day, use 1 with lag = 0
#'@param cl cluster that will be used for computation
#'@param lag number of TRADING day lag, default is 0; 1 mean lag by one trading day
#'@export
